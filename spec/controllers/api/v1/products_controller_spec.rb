...
RSpec.describe Api::V1::ProductsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    it 'gets first page' do
      ...
      expect(assigns(:products)).to eq products.first 10
      expect(response).to have_http_status(:success)
    end

    it 'gets the second page' do
      get :index, format: :json, page: 2
      expect(assigns(:products)).to eq products.last 10
      expect(response).to have_http_status(:success)
    end
    ...
    it 'should get medium price products' do
      ...
      expect(assigns(:products)).not_to include cheep_product
      expect(assigns(:products)).not_to include expensive_product
    end

    it 'should order the products' do
      products = []
  ...
  describe 'GET #info' do
    it 'gets max and min from products' do
  ...
  describe 'test responce' do
    ...
    it 'should print max end min from products' do
      create :product, price: 10
      create_list :product, 3, price: 50
      create :product, price: 90
      get :info, format: :json
